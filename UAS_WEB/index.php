...
<html lang="en">
  <head>
    ...
    <title>Dafian Ilham Pratama</title>
  </head>
  <body>
    <!-- Header -->
    <header>
      <div class="main-container">
        ...
        <section id="hero">
          <div class="hero-left">
            ...
            <h1 class="hero-name">Dafian <span>Ilham</span></h1>
            <p>
              Creative web developer and UI/UX with more than 1 years of experience
              in freelancer.
            </p>
          </div>

          <div class="hero-right">
            <img src="./image/heroes.jpg" alt="Person Standing" />
          </div>
        </section>
      </div>
    </header>
    ...
    <section id="services">
      <div class="services main-container">
        ...
        <h1 class="section-title services-title">Specialist In</h1>
        ...
        <div class="grid-3">
          <div class="service">
            ...
            <h4>UI/UX Design</h4>
            <p>
              Applying design principles is included to ensure an accessible experience for all users.
            </p>
          </div>
          ...
          <div class="service">
            ...
            <p>
              Create and maintenance your websites and also take care of it's
        ...
        <div class="grid-3">
          ...
          <div class="portfolio">
            ...
            <div class="portfolio-info">
              ...
              <p>
                Designing a hotel web design using figma
              </p>
            </div>
          </div>
          ...
          <div class="portfolio">
            ...
            <div class="portfolio-info">
              ...
              <p>
                Make design app school schedule
              </p>
            </div>
          </div>
        ...
        <div class="skills-grid">
          <div class="skills-left">
            <div class="education">
              ...
              <div class="education-info">
                <h4 class="education-title">University IKIP PGRI Madiun</h4>
                <p>Informatics Engineering</p>
                <h4 class="education-years">2021 - 2023</h4>
              </div>
            </div>
          ...
          <div class="skills-right">
            <p>
              ...
              UI/UX and Web Development experimenting with new technologies and frameworks,
    ...
    <section id="contact">
      <div class="contact main-container">
        <div class="contact-left">
          <form
            method="POST"
            class="contact-form" action="process.php" method="POST"
          >
            <div>
    ...
    <footer>
      <div class="footer-icons">
        <a href="https://www.instagram.com/dafianilham/?next=%2F">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
        ...
        <a href="https://github.com/daxgo75/daxgo75.github.io">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
